...
import com.wfc.boot.core.shiro.ShiroRealm;
 ...
 *
 * @author wangfc
 * @date 2017-09-24 15:09
 */
@Configuration
public class ShiroConfig {

    @Bean
    public DefaultSecurityManager securityManager(CookieRememberMeManager rememberMeManager, CacheManager cacheShiroManager, SessionManager sessionManager){
     ...
     */
    @Bean
    //@ConditionalOnProperty(prefix = SystemProperties.SYSTEM_PREFFIX, name = "spring-session-open", havingValue = "false")
